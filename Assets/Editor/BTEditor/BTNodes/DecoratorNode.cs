...
{
    private string label = "Decorator";
    ...
    public DecoratorNode(Vector2 position)
    {
        InitiateStyle();
    ...
    public DecoratorNode(Vector2 position, OnClickAsInPoint OnClickInPoint, OnClickAsOutPoint OnClickOutPoint, Action<BaseNode> OnClickRemoveNode)
    {
        InitiateStyle();
