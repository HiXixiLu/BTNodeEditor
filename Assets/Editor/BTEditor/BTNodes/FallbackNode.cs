...
public class FallbackNode : BaseNode
{
    ...
    public FallbackNode(Vector2 position)
    {
        InitiateStyle();
    ...
    public FallbackNode(Vector2 position, OnClickAsInPoint OnClickInPoint, OnClickAsOutPoint OnClickOutPoint, Action<BaseNode> OnClickRemoveNode)
    {
        InitiateStyle();
